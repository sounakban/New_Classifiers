...
selected_terms = chisqure(train_docs, train_labels, feature_count = 17000)
...
classifier = KerasBlog_CNN_Classifier(filter_sizes=[5,5,5], filter_counts=[128,128,128], pool_windows=[2,2], learning_rate=0.0001, batch_size=64, num_epochs=30)
