...
classifier = CNN_Classifier(filter_sizes=[3,4,5,6,7], filter_counts=[100, 100, 100, 100, 100], pool_windows=[6,5,4,3,2], learning_rate=0.001, batch_size=128, num_epochs=10)
