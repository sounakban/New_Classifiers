...
kf = KFold(n_splits=5)
from Tools.Classifier import CNN1_Classifier, RNN_Classifier, BDRNN_Classifier, Nested_CNN_Classifier, Stacked_BiLSTM_Classifier
...
classifier = CNN1_Classifier(filter_sizes=[3,4,5], filter_counts=[40,40,40], pool_windows=[10,10,10], learning_rate=0.001, batch_size=50, num_epochs=7)
