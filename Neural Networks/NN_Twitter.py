...
# classifier = CNN_Classifier(filter_sizes=[3,7], filter_counts=[300, 450], pool_windows=[6,3], learning_rate=0.001, batch_size=256, num_epochs=10)
classifier = CNN_Classifier(filter_sizes=[3,4,5,6,7], filter_counts=[100, 100, 100, 100, 100], pool_windows=[3,3,2,2,2], learning_rate=0.001, batch_size=128, num_epochs=10)
