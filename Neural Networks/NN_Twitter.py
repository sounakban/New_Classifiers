...
selected_terms = chisqure(data, labels, feature_count = 1000)
...
classifier = CNN_Classifier(filter_sizes=[3,7], filter_counts=[300, 450], pool_windows=[6,3], learning_rate=0.001, batch_size=256, num_epochs=30)
