...
classifier = CNN_Classifier(filter_sizes=[3,4,5,6,7], filter_counts=[200, 200, 200, 200, 200], pool_windows=[6,5,4,3,2], learning_rate=0.001, batch_size=256, num_epochs=10)
