...
# classifier = CNN_Classifier(filter_sizes=[3,5,7], filter_counts=[150,200,300], pool_windows=[8,15,14], learning_rate=0.01, batch_size=64, num_epochs=10)
classifier = CNN_Classifier(filter_sizes=[5,7], filter_counts=[200,300], pool_windows=[15,14], learning_rate=0.01, batch_size=64, num_epochs=10)
