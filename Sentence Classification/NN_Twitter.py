...
kf = KFold(n_splits=5)
from Tools.Classifier import CNN_Classifier, RNN_Classifier, BDRNN_Classifier, Nested_CNN_Classifier, Stacked_BiLSTM_Classifier
...
classifier = Stacked_BiLSTM_Classifier(output_size=128, learning_rate=0.001, batch_size=256, num_epochs=15)
